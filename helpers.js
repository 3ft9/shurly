...
exports.formatTimestamp = function(unixTimestamp) {
	...
	var day = dt.getDay();
	var daySuffix = ((day == 1 || day == 21 || day == 31) ? 'st' : ((day == 2 || day == 22) ? 'nd' : ((day == 3 || day == 23) ? 'rd' : 'th')));
	...
	return hours + ':' + minutes + ':' + seconds + ' on ' + months[month] + ' ' + day + daySuffix + ', ' + year;
}

// From http://www.strictly-software.com/scripts/downloads/encoder.js
...
// From http://snipplr.com/view/139/base-conversion/
...
exports.base = function(dec, base) {
	var len = base.length;
	var ret = '';
	while (dec > 0) {
...
exports.unbase = function(num, base) {
	var len = base.length;
	var ret = 0;
